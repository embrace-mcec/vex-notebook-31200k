        ...
        <div className="container max-w-6xl mx-auto px-8 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              {/* Disclaimer */}
              <div className="mt-8 p-4 border text-xs" style={{ borderColor: "rgba(255,183,3,0.2)", background: "rgba(255,183,3,0.04)" }}>
                <div style={{ color: "rgba(255,255,255,0.5)" }}>
                  <strong style={{ color: "#FFB703" }}>⚡ Disclaimer:</strong> This interactive site was generated by Manus AI based on the team's digital notebook — purely for fun and visual exploration. 
                  <a href="https://drive.google.com/file/d/1bef_fgSsYnDYQaQP_ZbmuP0qvX6yoWlf/view?usp=drive_link" target="_blank" rel="noopener noreferrer" style={{ color: "#FFB703", marginLeft: "4px" }}>
                    📥 Download the official notebook here
                  </a>
                </div>
              </div>
            </div>
